...
// 2). In this example  - var subInstance = Car("Honda","zt30",2024); -- in here we create instance of a class now subInstance can access now all the properties and method that car class is used
